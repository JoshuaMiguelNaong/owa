import PaymentsMadeListDropdown from "./details/items-list/payments-made-list-dropdown";
import PaymentsMadeTable from "./components/table/payments-made-table";
    ...
    <>
      ...
      <div className="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
        ...
        <div className="d-flex gap-2 mt-4 mt-md-0 me-4">
          <Link
            href={"/admin/v2/payments-made/new"}
