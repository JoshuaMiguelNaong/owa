  ...
  //import PurchaseEmail from "../tabs/email";
  import PurchaseDownloadPDF from "../tabs/download-pdf";
  ...
  export default function PurchaseOrderTabs({ id }: { id: string }) {
    ...
    return (
      <div>
        ...
        <div className="tab-content" id="purchase-order-tabs-content">
          {list.map((tab) => {
